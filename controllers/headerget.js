...
exports.getHeaderCoords_loggedrestricted = (req, res, next) =>{
  sql = `
    SELECT * 
      FROM 
    `
...
exports.getHeaderCoords_loggedrestricted_lmflimited = (req, res, next) =>{
  sql = `
    SELECT * 
      FROM 
    `
...
exports.getHeaderCoords_loggedrestricted_datelimited = (req, res, next) =>{
  sql = `
    SELECT * 
      FROM 
    `
